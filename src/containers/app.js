...
const API_KEY = "api_key=c27d78a6b22c2cc0cc18390312189937";
...
class App extends Component{
  ...
  applyVideoToCurrentMovie(){
        axios.get(`${API_END_POINT}movie/${this.state.currentMovie.id}/videos?language=fr-FR&append_to_repsonse=videos&include_adult=false&${API_KEY}`).then(
            function(response){
